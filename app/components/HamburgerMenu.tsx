    ...
    const primaryLinks = useMemo(() => [
        ...
        },
        {
            ...
            subItems: [
                ...
                { name: 'AURELIC SYSTEMS', href: '/houses/aurelic' },
                        ...
                        <div className="px-8 pt-2 pb-8 mt-auto">
                            <div className="flex items-center gap-5">
                                {[
                                    ...
                                    <a key={social.name} href="#" className="text-foreground/40 hover:text-foreground/80 transition-colors duration-300" aria-label={social.name}>
                            ...
                            <div className="mt-5 max-h-[50vh] overflow-y-auto">
                                {searchQuery.trim() ? (() => {
                                    ...
                                    const allPages = [
                                        ...
                                        { name: dict.pages.aurelicPlatform.title, href: '/news/aurelic-platform' },
