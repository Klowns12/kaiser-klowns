...
const footerLinks = {
    group: [
        ...
        { label: "Mission", href: "/group/mission" },
        { label: "Governance", href: "/group/governance" },
    ],
    houses: [
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                            ...
                            {footerLinks.houses.map((link) => (
                                <li key={link.href}>
                                    {'locked' in link && link.locked ? (
                                        <span className="text-[11px] tracking-[0.05em] text-white/15 cursor-default">
                                            {link.label}
                                        </span>
                                    ) : (
                                        <Link
                ...
                <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <p className="text-[10px] tracking-[0.1em] text-white/20">
                        © {new Date().getFullYear()} KAISER KLOWNS. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
