    ...
    houseDetails: {
        ...
        Anthovai: {
            ...
            projects: [
                ...
                { title: "クラウド移行とCI/CDのセットアップ", description: "レガシーなローカルサーバーからクラウドインフラストラクチャ（AWS/GCP）への移行と、自動化されたCI/CDデプロイメントパイプライン。" },
                { title: "カスタムCRMとリード管理", description: "既存の販売チャネルやソーシャルメディアAPIと統合する、カスタマイズされた顧客関係管理ポータル。" },
                { title: "人的資源情報システム (HRIS)", description: "デジタル休暇申請、従業員記録、および自動給与計算のための社内Webアプリケーション。" },
                { title: "クリニック順番待ち管理アプリ", description: "患者の順番待ち予約とリアルタイムのステータス追跡のためのクロスプラットフォームモバイルアプリケーション。" },
                { title: "社内ナレッジベースチャットボット", description: "企業ハンドブックや操作マニュアルを参照して、従業員のFAQに回答するAI搭載の社内アシスタント。" },
        ...
        lokovox: {
            ...
            projects: [
                { title: "デジタルマーケティングとブランディング", description: "包括的なオンラインマーケティングキャンペーン、ブランドポジショニング、ソーシャルメディア戦略。" },
                { title: "コンテンツ制作", description: "高品質のポスターデザイン、プロモーションビデオ、魅力的なマルチメディアコンテンツ。" },
                { title: "コーポレートアイデンティティ (CI) デザイン", description: "大企業向けのロゴ、カラーパレット、タイポグラフィ、包括的なブランドブックを含む完全なビジュアルアイデンティティエンジニアリング。" },
                { title: "バイラルソーシャルメディアキャンペーン", description: "1か月以内に1,000万回以上のオーガニックリーチを生み出す、影響力の大きいデジタルキャンペーンの戦略と実行。" },
                { title: "インフルエンサーマーケティング戦略", description: "大規模なブランド認知度とコンバージョンを促進するための、トップ層のKOLとインフルエンサーとのキャンペーンの包括的な管理。" },
            ],
        },
    },
    philosophy: {
