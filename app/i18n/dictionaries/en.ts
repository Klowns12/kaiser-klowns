    ...
    houseDetails: {
        ...
        Anthovai: {
            ...
            highlights: [
                ...
                "Allist — The memory and backbone of the entire system. Stores all company data (RAG/Context) + KKG: a next-gen version control engine with smart commits, insights, and encryption.",
                "KlownsNexus Office Suite — The complete business operating layer. HR, Support, Finance, Project, and Inventory — all AI-assisted by Arkai and powered by Allist.",
            ],
            projects: [
                ...
                { title: "Custom B2B E-Commerce Portal", description: "Wholesale ordering system with credit limit management and seamless API integrations with accounting software." },
                { title: "Cloud Migration & CI/CD Setup", description: "Migrating legacy local servers to Cloud infrastructure (AWS/GCP) along with automated CI/CD deployment pipelines." },
                { title: "Custom CRM & Lead Management", description: "Tailored Customer Relationship Management portal integrating with existing sales channels and social media APIs." },
    ...
    pages: {
        ...
        AnthovaiPlatform: {
            ...
            paragraphs: [
                ...
                'The suite includes four proprietary platforms: Arkai (AI-powered intelligent automation), Aello (integrated development environment with AI capabilities), Allist (enterprise resource management), and KlownsNexus Office Suite (complete business operations platform).',
